// REGLAGE DU CARROUSEL
        ...
        $carrousel.append('<div class="controls"><span class="prev"><i class="fas fa-hand-point-left"></i></span><span class="next"><i class="fas fa-hand-point-right"></i></span></div>'); // ajout des boutons précédent et suivant par l'ajout d'une div dans le code HTML
        ...
        $('.next').click(function(){ 
            ...
            // if (i <= indexImg){
            //     $img.css ('display', 'none'); // on cache les images
            //     $currentImg=$img.eq(i); // on définit la nouvelle image et on utilise % pour créer une boucle infini
            //     $currentImg.css('display','block'); // puis on l'affiche
            // }
            // else {
            //     i=indexImg;
